// ==UserScript==
// @name         Buildroyale.io Hacks Cheats Mods 2019 - Working - (sandbox-unblocked) by ioMods.org
// @description  Buildroyaleio Mods Features: Aimbot, Build Helper, Auto Heal, Extra Food, FPS, Adblock Created by ioMods.org
// @namespace    iomods.org
// @author       iomods.org
// @version      1
// @require      http://code.jquery.com/jquery-3.3.1.min.js
// @updateURL    https://iomods.org/mods/buildroyaleio.user.js
// @downloadURL  https://iomods.org/mods/buildroyaleio.user.js
// @match        *://buildroyale.io/*
// @match        *iogames.space/*
// @match        *titotu.io/*
// @match        *io-games.io/*
// ==/UserScript==
...
//genel isimlendirme ve ayarlar
 this.settings = {
     ...
     fpsstyle: "border:1px solid black;border-radius:20px;text-align:center;padding:3px;width:80px;height:20px;font-size: 15px;background-color: rgba(0, 0, 0, 0.8);color:white;",
...
//degisenkisimlar
$('#reftopleft').prepend('<div style="'+this.settings.fpsstyle+'" id="fps" class="fps"></div>');
$('#ref2').html('<div style="'+this.settings.formstyle+'"><div class="option1"></div>'+this.settings.youtuber+''+this.settings.facebooker+'</div>');
$('#ref1').html('<div class="list1"></div>');
//general
...
$('canvas').css('background-color',''+changecolor+'');
}
...
function colorfulmod() {
    ...
    colorsrain = ["#0085ff"];
      ...
      setInterval(function() {
                ...
                $("canvas").css("background-color",selectedcolor);
      }, 3000);
}
